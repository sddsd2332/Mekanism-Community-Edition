...
public enum Action {
    ...
    private final BooleanSupplier fluidAction;

    Action(BooleanSupplier fluidAction) {
     ...
     */
    public BooleanSupplier toFluidAction() {
        return fluidAction;
    }
     ...
     * @return Action.
     */
    public static Action fromFluidAction(BooleanSupplier action) {
