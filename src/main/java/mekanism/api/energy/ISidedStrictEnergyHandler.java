...
public interface ISidedStrictEnergyHandler extends IStrictEnergyHandler {
     ...
     */
    FloatingLong getEnergy(int container, @Nullable EnumFacing side);
     ...
     **/
    void setEnergy(int container, FloatingLong energy, @Nullable EnumFacing side);
     ...
     */
    FloatingLong getMaxEnergy(int container, @Nullable EnumFacing side);
     ...
     */
    FloatingLong getNeededEnergy(int container, @Nullable EnumFacing side);
     ...
     */
    FloatingLong insertEnergy(int container, FloatingLong amount, @Nullable EnumFacing side, Action action);
     ...
     */
    FloatingLong extractEnergy(int container, FloatingLong amount, @Nullable EnumFacing side, Action action);
    ...
    /**
     * A sided variant of {, docs copied for convenience.
     *
     * <p>
     ...
     */
    default FloatingLong extractEnergy(FloatingLong amount, @Nullable EnumFacing side, Action action) {
