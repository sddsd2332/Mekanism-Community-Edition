...
public interface IMekanismStrictEnergyHandler  extends ISidedStrictEnergyHandler, IContentsListener {
    ...
    @Override
    default FloatingLong getEnergy(int container, @Nullable EnumFacing side) {
    ...
    @Override
    default void setEnergy(int container, FloatingLong energy, @Nullable EnumFacing side) {
        IEnergyContainer energyContainer = getEnergyContainer(container, side);
    ...
    @Override
    default FloatingLong getMaxEnergy(int container, @Nullable EnumFacing side) {
        IEnergyContainer energyContainer = getEnergyContainer(container, side);
        return energyContainer == null ? FloatingLong.ZERO : energyContainer.getMaxEnergy();
    }

    @Override
    default FloatingLong getNeededEnergy(int container, @Nullable EnumFacing side) {
        IEnergyContainer energyContainer = getEnergyContainer(container, side);
        return energyContainer == null ? FloatingLong.ZERO : energyContainer.getNeeded();
    }

    @Override
    default FloatingLong insertEnergy(int container, FloatingLong amount, @Nullable EnumFacing side, Action action) {
        IEnergyContainer energyContainer = getEnergyContainer(container, side);
    ...
    @Override
    default FloatingLong extractEnergy(int container, FloatingLong amount, @Nullable EnumFacing side, Action action) {
        IEnergyContainer energyContainer = getEnergyContainer(container, side);
