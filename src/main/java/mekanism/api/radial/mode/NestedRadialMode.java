...
@Desugar
public record  NestedRadialMode(@NotNull RadialData<?> nestedData, @NotNull String sliceName, @NotNull ResourceLocation icon, @Nullable EnumColor color) implements INestedRadialMode {
     ...
     */
    public NestedRadialMode(@NotNull RadialData<?> nestedData, @NotNull String sliceName, @NotNull ResourceLocation icon) {
    ...
    public NestedRadialMode(@NotNull RadialData<?> nestedData, @NotNull ILangEntry sliceName, @NotNull ResourceLocation icon, @NotNull EnumColor color) {
        this(nestedData, sliceName.translate(color), icon, color);
    }
