...
public interface ISidedItemHandler extends IItemHandlerModifiable {
     ...
     */
    @Nullable
    default EnumFacing getInventorySideFor() {
        return null;
    }
     ...
     */
    void setStackInSlot(int slot, ItemStack stack, @Nullable EnumFacing side);
     ...
     */
    int getSlots(@Nullable EnumFacing side);
     ...
     */
    ItemStack getStackInSlot(int slot, @Nullable EnumFacing side);
     ...
     */
    ItemStack insertItem(int slot, ItemStack stack, @Nullable EnumFacing side, Action action);
     ...
     */
    ItemStack extractItem(int slot, int amount, @Nullable EnumFacing side, Action action);
     ...
     */
    int getSlotLimit(int slot, @Nullable EnumFacing side);
     ...
     *
     * <p>
     * This function re-implements the vanilla function {@link IInventory#canPlaceItem(int, ItemStack)}{@link IInventory#isItemValidForSlot(int, ItemStack)}. It should be used instead of simulated insertions in cases where
     ...
     */
    boolean isItemValid(int slot, ItemStack stack, @Nullable EnumFacing side);
