...
public interface IModule<MODULE extends ICustomModule<MODULE>> {
     ...
     */
    void displayModeChange(EntityPlayer player, String modeName, String mode);
     ...
     * @since 10.4.0
     */
    boolean hasEnoughEnergy(double energySupplier);
     ...
     */
    boolean canUseEnergy(EntityLivingBase wearer, FloatingLong energy);
     ...
     * @return {@code true} if the energy can be used/provided.
     */
    boolean canUseEnergy(EntityLivingBase wearer, FloatingLong energy, boolean ignoreCreative);
     ...
     */
    boolean canUseEnergy(EntityLivingBase wearer, @Nullable IEnergyContainer energyContainer, FloatingLong energy, boolean ignoreCreative);
     ...
     */
    FloatingLong useEnergy(EntityLivingBase wearer, FloatingLong energy);
     ...
     * @return Actual amount of energy used.
     */
    FloatingLong useEnergy(EntityLivingBase wearer, FloatingLong energy, boolean freeCreative);
     ...
     * @apiNote This method is mostly for use in not having to look up the energy container multiple times.
     */
    FloatingLong useEnergy(EntityLivingBase wearer, @Nullable IEnergyContainer energyContainer, FloatingLong energy, boolean freeCreative);
}