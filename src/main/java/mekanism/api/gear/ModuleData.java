...
public class ModuleData<MODULE extends ICustomModule<MODULE>> extends IForgeRegistryEntry.Impl<ModuleData<?>> implements IModuleDataProvider<MODULE> {
    ...
    public String getTranslationKey() {
        if (translationKey == null) {
            translationKey = makeDescriptionId("module", getRegistryName());
        }
        return translationKey;
    }

    public static String makeDescriptionId(String pType, @javax.annotation.Nullable ResourceLocation pId) {
    ...
    public String getDescriptionTranslationKey() {
        if (descriptionTranslationKey == null) {
            descriptionTranslationKey = makeDescriptionId("description", getRegistryName());
        }
    ...
    public static class ModuleDataBuilder<MODULE extends ICustomModule<MODULE>> {
         ...
         *
         */
        public static <MODULE extends ICustomModule<MODULE>> ModuleDataBuilder<MODULE> custom(NonNullSupplier<MODULE> customModule) {
        ...
        public ModuleDataBuilder(NonNullSupplier<MODULE> supplier) {
         ...
         */
        public ModuleDataBuilder<MODULE> rarity(EnumRarity rarity) {
         ...
         * {@link ICustomModule#changeMode(IModule, EntityPlayer, ItemStack, int, boolean)} should be implemented.
         */
        ...
        /**
         * Marks this module type as having HUD elements to render. In addition to using this method {@link ICustomModule#addHUDElements(IModule, EntityPlayer, Consumer)} or
         * {@link ICustomModule#addHUDStrings(IModule, EntityPlayer, Consumer)} should be implemented.
         */
