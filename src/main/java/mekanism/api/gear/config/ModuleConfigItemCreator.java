...
public interface ModuleConfigItemCreator {
     ...
     */
    <TYPE> IModuleConfigItem<TYPE> createConfigItem(String name, String description, ModuleConfigData<TYPE> data);
     ...
     * @return A new {@link IModuleConfigItem}.
     */
    IModuleConfigItem<Boolean> createDisableableConfigItem(String name, String description, boolean def, BooleanSupplier isConfigEnabled);
}