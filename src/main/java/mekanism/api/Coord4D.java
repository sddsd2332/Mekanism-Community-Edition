...
public class Coord4D {//TODO - V11: Continue working on replacing uses of this with BlockPos/GlobalPos where appropriate
    ...
    public Coord4D(Entity entity) {
        this(entity.lastPortalPos, entity.world.provider.getDimension());
    }
    ...
    public Coord4D(TileEntity tile) {
        this(tile.getPos(), Objects.requireNonNull(tile.getWorld(), "Block entity has no level."));
    }
    ...
    public static Coord4D read(NBTTagCompound tag) {
        return new Coord4D(tag.getInteger(NBTConstants.X), tag.getInteger(NBTConstants.Y), tag.getInteger(NBTConstants.Z), tag.getInteger(NBTConstants.DIMENSION));
    }
    ...
    public NBTTagCompound write(NBTTagCompound nbtTags) {
        nbtTags.setInteger(NBTConstants.X, x);
        nbtTags.setInteger(NBTConstants.Y, y);
        nbtTags.setInteger(NBTConstants.Z, z);
        nbtTags.setInteger(NBTConstants.DIMENSION, dimensionId);
        return nbtTags;
    }
    ...
    public boolean equals(Object obj) {
        return obj instanceof Coord4D other && other.x == x && other.y == y && other.z == z && other.dimensionId == dimensionId;
    }
