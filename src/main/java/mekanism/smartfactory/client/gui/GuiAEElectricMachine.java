...
public class GuiAEElectricMachine<RECIPE extends BasicMachineRecipe<RECIPE>> extends GuiMekanismTile<TileEntityAEElectricMachine<RECIPE>> {

    public GuiAEElectricMachine(InventoryPlayer inventory, TileEntityAEElectricMachine<RECIPE> tile) {
        super(tile, new ContainerAEElectricMachine<>(inventory, tile));
        ...
        addGuiElement(new GuiSlot(GuiSlot.SlotType.POWER, this, resource, 55, 52).with(GuiSlot.SlotOverlay.POWER));
