    ...
    public static void addRecipes() {
        ...
        if (MekanismConfig.current().multiblock.multiblockmachinesManager.isEnabled(BlockStateMultiblockMachine.MultiblockMachineType.DIGITAL_ASSEMBLY_TABLE)) {
            ...
            RecipeHandler.addDigitalAssemblyTableRecipe(
                    ...
                    FluidRegistry.getFluidStack("water", 20000), new GasStack(MekanismFluids.Oxygen, 10000),
                    new ItemStack(MultiblockMachineBlocks.MultiblockGenerator, 1, 1), FluidRegistry.getFluidStack("water", 1000), new GasStack(MekanismFluids.Water, 1000)
                    , 100, 2400);
            ...
            RecipeHandler.addDigitalAssemblyTableRecipe(
                    ...
                    FluidRegistry.getFluidStack("water", 20000), new GasStack(MekanismFluids.Oxygen, 10000),
                    new ItemStack(MultiblockMachineBlocks.MultiblockGenerator, 1, 2), FluidRegistry.getFluidStack("water", 1000), new GasStack(MekanismFluids.Water, 1000), 100, 2400);
