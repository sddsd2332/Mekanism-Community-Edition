...
public class ItemBlockMultiblockGasTank extends ItemBlock implements IGasItem, ISustainedInventory, ISecurityItem {
    ...
    public boolean placeBlockAt(@Nonnull ItemStack stack, @Nonnull EntityPlayer player, World world, @Nonnull BlockPos pos, EnumFacing side, float hitX, float hitY,
        ...
        if (stack.getItem() instanceof ItemBlockMultiblockGasTank) {
            if (!(block.isReplaceable(world, pos) && world.isAirBlock(pos.add(0, 1, 0)) && world.isAirBlock(pos.add(0, -1, 0)))) {
                place = false;
            }
        }
