...
import mekanism.multiblockmachine.common.block.states.BlockStateMultiblockGasTank;
...
public class BlockMultiblockGasTank extends BlockMekanismContainer {

    public BlockMultiblockGasTank() {
        super(Material.IRON);
        setHardness(3.5F);
        setResistance(8F);
    ...
    protected BlockStateContainer createBlockState() {
        return new BlockStateMultiblockGasTank(this);
    }
    ...
    public IBlockState getActualState(@Nonnull IBlockState state, IBlockAccess worldIn, BlockPos pos) {
        ...
        if (tile instanceof TileEntityMultiblockGasTank tank) {
            if (tank.facing != null) {
    ...
    public boolean onBlockActivated(World world, BlockPos pos, IBlockState state, EntityPlayer entityplayer, EnumHand hand, EnumFacing side, float hitX, float hitY, float hitZ) {
        ...
        TileEntityMultiblockGasTank tileEntity = (TileEntityMultiblockGasTank) world.getTileEntity(pos);
    ...
    public TileEntity createNewTileEntity(@Nonnull World world, int meta) {
        return new TileEntityMultiblockGasTank();
    }
    ...
    protected ItemStack getDropItem(@Nonnull IBlockState state, @Nonnull IBlockAccess world, @Nonnull BlockPos pos) {
        TileEntityMultiblockGasTank tileEntity = (TileEntityMultiblockGasTank) world.getTileEntity(pos);
        ItemStack itemStack = new ItemStack(MultiblockMachineBlocks.MultiblockGasTank);
