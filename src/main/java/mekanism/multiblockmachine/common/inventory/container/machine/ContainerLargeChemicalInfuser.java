...
public class ContainerLargeChemicalInfuser extends ContainerMekanism<TileEntityLargeChemicalInfuser> {
    ...
    protected void addSlots() {
        ...
        addSlotToContainer(new SlotEnergy.SlotDischarge(tileEntity, 3, 155, 5 + 11));
    }
}
