...
public class ContainerLargeChemicalWasher extends ContainerMekanism<TileEntityLargeChemicalWasher> {
    ...
    protected void addSlots() {
        ...
        addSlotToContainer(new SlotEnergy.SlotDischarge(tileEntity, 3, 155, 14));
    }
}
