...
public class ModelLargeChemicalWasher extends ModelBase {
	...
	public ModelLargeChemicalWasher() {
		...
		glass.cubeList.add(new ModelBox(glass, 158, 51, 7.0F, -40.0F, -23.5F, 6, 15, 1, 0.0F, false));
		glass.cubeList.add(new ModelBox(glass, 88, 129, 12.0F, -38.0F, 22.5F, 6, 15, 1, 0.0F, false));
		glass.cubeList.add(new ModelBox(glass, 88, 129, -18.0F, -40.0F, -23.5F, 6, 15, 1, 0.0F, false));
