...
public class GuiMekanismConfig extends GuiConfig {
    ...
    public static class MEKCEEntry extends CategoryEntry {
        ...
        @Override
        protected GuiScreen buildChildScreen() {
            return new GuiConfig(owningScreen, new ConfigElement(Mekanism.configurationce.getCategory("mekce")).getChildElements(), owningScreen.modID,
                    Configuration.CATEGORY_GENERAL, false, false, GuiConfig.getAbridgedConfigPath(Mekanism.configurationce.toString()));
        }
    }
