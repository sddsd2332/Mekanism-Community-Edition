...
public class GuiOredictionificatorFilter extends GuiTextFilterBase<OredictionificatorFilter, TileEntityOredictionificator> {
    ...
    protected void drawGuiContainerForegroundLayer(int mouseX, int mouseY) {
        ...
        if (xAxis >= 31 && xAxis <= 43 && yAxis >= 21 && yAxis <= 33) {
            this.olddisplayTooltip(LangUtils.localize("gui.lastItem"), xAxis, yAxis);
        } else if (xAxis >= 63 && xAxis <= 75 && yAxis >= 21 && yAxis <= 33) {
            this.olddisplayTooltip(LangUtils.localize("gui.nextItem"), xAxis, yAxis);
        } else if (xAxis >= 33 && xAxis <= 129 && yAxis >= 48 && yAxis <= 60) {
            this.olddisplayTooltip(LangUtils.localize("gui.oreDictCompat"), xAxis, yAxis);
            ...
            if (!renderStack.isEmpty()) {
                ...
                this.olddisplayTooltip(renderStack.getDisplayName() + extra, xAxis, yAxis);
            }
        }
