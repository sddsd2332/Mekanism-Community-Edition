...
public class GuiMItemStackFilter extends GuiItemStackFilter<MItemStackFilter, TileEntityDigitalMiner> {
    ...
    protected void drawForegroundLayer(int mouseX, int mouseY) {
        ...
        if (replaceButton.isMouseOver()) {
            this.olddisplayTooltip(LangUtils.localize("gui.digitalMiner.requireReplace") + ": " + LangUtils.transYesNo(filter.requireStack), xAxis, yAxis);
        } else if (fuzzyButton.isMouseOver()) {
            this.olddisplayTooltip(LangUtils.localize("gui.digitalMiner.fuzzyMode") + ": " + LangUtils.transYesNo(filter.fuzzy), xAxis, yAxis);
        }
    }
