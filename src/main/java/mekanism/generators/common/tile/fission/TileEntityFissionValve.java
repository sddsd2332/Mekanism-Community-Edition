...
import mekanism.generators.common.content.fission.*;
...
public class TileEntityFissionValve extends TileEntityFissionCasing implements IFluidHandlerWrapper, IComputerIntegration, IComparatorSupport, IGasHandler, IConfigurable {

    private static final String[] methods = new String[]{"isFormed", "getSteam", "getWater", "getBoilRate", "getMaxBoilRate", "getTemp"};
    public FissionTank waterTank;
    ...
    public TileEntityFissionValve() {
        ...
        inputTank = new FissionInputGasTank(this);
        outputTank = new FissionOutputGasTank(this);
    }
