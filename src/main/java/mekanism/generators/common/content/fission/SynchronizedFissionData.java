...
public class SynchronizedFissionData extends SynchronizedData<SynchronizedFissionData> implements IHeatTransfer {
    ...
    public static double BASE_BOIL_TEMP = 100 - (UnitDisplayUtils.TemperatureUnit.AMBIENT.zeroOffset - UnitDisplayUtils.TemperatureUnit.CELSIUS.zeroOffset);
