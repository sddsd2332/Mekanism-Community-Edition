...
public class ItemOldMekAsuitHeadArmour extends ItemOldMekaSuitArmor implements IGasItem, IItemHUDProvider {

    public boolean isVision = false;

    public ItemOldMekAsuitHeadArmour() {
    ...
    public void onArmorTick(World world, EntityPlayer player, ItemStack itemStack) {
        ...
        if (!world.isRemote) {
            ...
            if (headStack.getItem() instanceof ItemOldMekAsuitHeadArmour item) {
                ...
                if (UpgradeHelper.isUpgradeInstalled(itemStack, moduleUpgrade.ElectrolyticBreathingUnit) && getElectrolyticBreathing(itemStack)) {
                    if (player.isEntityAlive() && player.isInsideOfMaterial(Material.WATER)) {
                        ...
                        if (chestStack.getItem() instanceof ItemOldMekAsuitBodyArmour armour && UpgradeHelper.isUpgradeInstalled(chestStack, moduleUpgrade.JETPACK_UNIT)) {
