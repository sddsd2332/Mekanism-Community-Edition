...
public class ItemOldMekAsuitLegsArmour extends ItemOldMekaSuitArmor implements IItemHUDProvider {

    public ItemOldMekAsuitLegsArmour() {
    ...
    public void onArmorTick(World world, EntityPlayer player, ItemStack itemStack) {
        ...
        if (!world.isRemote) {
            ...
            if (legStack.getItem() instanceof ItemOldMekAsuitLegsArmour armour) {
