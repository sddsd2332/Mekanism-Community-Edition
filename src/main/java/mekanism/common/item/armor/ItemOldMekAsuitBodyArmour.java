...
public class ItemOldMekAsuitBodyArmour extends ItemOldMekaSuitArmor implements IGasItem, IJetpackItem {

    public ItemOldMekAsuitBodyArmour() {
    ...
    private void chargeSuit(EntityPlayer player) { //wip
        ...
        for (ItemStack stack : player.getArmorInventoryList()) {
            if (stack.getItem() instanceof ItemOldMekaSuitArmor armour) {
                energy += armour.getEnergy(stack);
                energyMax += armour.getMaxEnergy(stack);
            }
        }
        double FinalEnergy = energy / energyMax;
        for (ItemStack stack : player.getArmorInventoryList()) {
            if (stack.getItem() instanceof ItemOldMekaSuitArmor armour) {
                armour.setEnergy(stack, FinalEnergy * energyMax);
            }
        }
    }
    ...
    public void onArmorTick(World world, EntityPlayer player, ItemStack itemStack) {
        ...
        if (!world.isRemote) {
            ...
            if (headStack.getItem() instanceof ItemOldMekAsuitHeadArmour armour) {
            ...
            if (chestStack.getItem() instanceof ItemOldMekAsuitBodyArmour) {
