...
public class ItemOldMekAsuitFeetArmour extends ItemOldMekaSuitArmor {

    public ItemOldMekAsuitFeetArmour() {
    ...
    public void onArmorTick(World world, EntityPlayer player, ItemStack itemStack) {
        ...
        if (!world.isRemote) {
            ...
            if (feetStack.getItem() instanceof ItemOldMekAsuitFeetArmour armour) {
