...
public class DigitalAssemblyTableRecipe extends MachineRecipe<CompositeInput, CompositeOutput, DigitalAssemblyTableRecipe> {
    ...
    public DigitalAssemblyTableRecipe(ItemStack input, ItemStack input2, ItemStack input3, ItemStack input4, ItemStack input5, ItemStack input6, ItemStack input7, ItemStack input8, ItemStack input9, FluidStack inputFluid, GasStack inputGas, ItemStack output, FluidStack outputFluid, GasStack outputGas, double energy, int duration) {
