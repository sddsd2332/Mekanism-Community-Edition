...
/**
 * @apiNote Do not instantiate this class directly as it will be done via the service loader. Instead, access instances of this via {@link RadialDataHelper#INSTANCE}
 */
@NothingNullByDefault
public class RadialDataHelper implements IRadialDataHelper {

    public static RadialDataHelper INSTANCE = new RadialDataHelper();
