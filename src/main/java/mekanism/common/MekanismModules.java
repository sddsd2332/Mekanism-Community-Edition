 ...
 */
   ...
   */
    ...
    //  public static final ModuleData<ModuleMagneticAttractionUnit> MAGNETIC_ATTRACTION_UNIT = ModuleHelper.register("magnetic_attraction_unit",builder -> builder.maxStackSize(4).rarity(EnumRarity.RARE).handlesModeChange());
