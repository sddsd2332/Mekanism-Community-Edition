...
public class CommonProxy implements IGuiProvider
{
	...
	public void loadConfiguration()
	{
		...
		general.prefilledFluidTanks = Mekanism.configuration.get(Configuration.CATEGORY_GENERAL, "PrefilledFluidTanks", false).getBoolean();
		general.prefilledGasTanks = Mekanism.configuration.get(Configuration.CATEGORY_GENERAL, "PrefilledGasTanks", false).getBoolean();
		...
		general.enableSingleUseCardboxes = Mekanism.configuration.get(Configuration.CATEGORY_GENERAL, "EnableSingleUseCardboxes", true).getBoolean();
		...
		recipes.enableBins = Mekanism.configurationrecipes.get("Recipes","enableBins", true).getBoolean();
		recipes.enableTeleporterFrame = Mekanism.configurationrecipes.get("Recipes","enableTeleporterFrame", true).getBoolean();
		recipes.enableSteelCasing = Mekanism.configurationrecipes.get("Recipes","enableSteelCasing", true).getBoolean();
		recipes.enableDynamicTank = Mekanism.configurationrecipes.get("Recipes","enableDynamicTank", true).getBoolean();
		recipes.enableDynamicGlass = Mekanism.configurationrecipes.get("Recipes","enableDynamicGlass", true).getBoolean();
		recipes.enableDynamicValve = Mekanism.configurationrecipes.get("Recipes","enableDynamicValve", true).getBoolean();
		recipes.enableThermalEvaporationController = Mekanism.configurationrecipes.get("Recipes","enableThermalEvaporationController", true).getBoolean();
		recipes.enableThermalEvaporationValve = Mekanism.configurationrecipes.get("Recipes","enableThermalEvaporationValve", true).getBoolean();
		recipes.enableThermalEvaporationBlock = Mekanism.configurationrecipes.get("Recipes","enableThermalEvaporationBlock", true).getBoolean();
		recipes.enableInductionCasing = Mekanism.configurationrecipes.get("Recipes","enableInductionCasing", true).getBoolean();
		recipes.enableInductionPorts = Mekanism.configurationrecipes.get("Recipes","enableInductionPorts", true).getBoolean();
		recipes.enableInductionCells = Mekanism.configurationrecipes.get("Recipes","enableInductionCells", true).getBoolean();
		recipes.enableInductionProviders = Mekanism.configurationrecipes.get("Recipes","enableInductionProviders", true).getBoolean();
		recipes.enableSuperheatingElement = Mekanism.configurationrecipes.get("Recipes","enableSuperheatingElement", true).getBoolean();
		recipes.enablePressureDispenser = Mekanism.configurationrecipes.get("Recipes","enablePressureDispenser", true).getBoolean();
		recipes.enableBoilerCasing = Mekanism.configurationrecipes.get("Recipes","enableBoilerCasing", true).getBoolean();
		recipes.enableBoilerValve = Mekanism.configurationrecipes.get("Recipes","enableBoilerValve", true).getBoolean();
		...
		recipes.enableMetallurgicInfuser = Mekanism.configurationrecipes.get("Recipes","enableMetallurgicInfuser", true).getBoolean();
		recipes.enablePurificationChamber = Mekanism.configurationrecipes.get("Recipes","enablePurificationChamber", true).getBoolean();
		recipes.enableEnergizedSmelter = Mekanism.configurationrecipes.get("Recipes","enableEnergizedSmelter", true).getBoolean();
		recipes.enableTeleporterBlock = Mekanism.configurationrecipes.get("Recipes","enableTeleporterBlock", true).getBoolean();
		recipes.enableElectricPump = Mekanism.configurationrecipes.get("Recipes","enableElectricPump", true).getBoolean();
		recipes.enablePersonalChest = Mekanism.configurationrecipes.get("Recipes","enablePersonalChest", true).getBoolean();
		recipes.enableChargePad = Mekanism.configurationrecipes.get("Recipes","enableChargePad", true).getBoolean();
		recipes.enableLogisticalSorter = Mekanism.configurationrecipes.get("Recipes","enableLogisticalSorter", true).getBoolean();
		recipes.enableRotaryCondensentrator = Mekanism.configurationrecipes.get("Recipes","enableRotaryCondensentrator", true).getBoolean();
		recipes.enableChemicalOxidiser = Mekanism.configurationrecipes.get("Recipes","enableChemicalOxidiser", true).getBoolean();
		recipes.enableChemicalInfuser = Mekanism.configurationrecipes.get("Recipes","enableChemicalInfuser", true).getBoolean();
		recipes.enableChemicalInjection = Mekanism.configurationrecipes.get("Recipes","enableChemicalInjection", true).getBoolean();
		recipes.enableElectrolyticSeparator = Mekanism.configurationrecipes.get("Recipes","enableElectrolyticSeparator", true).getBoolean();
		recipes.enableElectroliticCore = Mekanism.configurationrecipes.get("Recipes","enableElectroliticCore", true).getBoolean();
		recipes.enableCardboardBox = Mekanism.configurationrecipes.get("Recipes","enableCardboardBox", true).getBoolean();
		recipes.enableSawdusttoPaper = Mekanism.configurationrecipes.get("Recipes","enableSawdusttoPaper", true).getBoolean();
		recipes.enablePrecisionSawmill = Mekanism.configurationrecipes.get("Recipes","enablePrecisionSawmill", true).getBoolean();
		recipes.enableChemicaDissolution = Mekanism.configurationrecipes.get("Recipes","enableChemicaDissolution", true).getBoolean();
		recipes.enableChemicalWasher = Mekanism.configurationrecipes.get("Recipes","enableChemicalWasher", true).getBoolean();
		recipes.enableChemicalCrystallizer = Mekanism.configurationrecipes.get("Recipes","enableChemicalCrystallizer", true).getBoolean();
		recipes.enableSeismicVibrator = Mekanism.configurationrecipes.get("Recipes","enableSeismicVibrator", true).getBoolean();
		recipes.enablePressurizedReactorChamber = Mekanism.configurationrecipes.get("Recipes","enablePressurizedReactorChamber", true).getBoolean();
		recipes.enableLiquidTanks = Mekanism.configurationrecipes.get("Recipes","enableLiquidTanks", true).getBoolean();
		recipes.enableFluidPlenisher = Mekanism.configurationrecipes.get("Recipes","enableFluidPlenisher", true).getBoolean();
		recipes.enableLaser = Mekanism.configurationrecipes.get("Recipes","enableLaser", true).getBoolean();
		recipes.enableLaserAmplifyier = Mekanism.configurationrecipes.get("Recipes","enableLaserAmplifyier", true).getBoolean();
		recipes.enableLaserTractorBeam = Mekanism.configurationrecipes.get("Recipes","enableLaserTractorBeam", true).getBoolean();
		recipes.enableEntangloporter = Mekanism.configurationrecipes.get("Recipes","enableEntangloporter", true).getBoolean();
		recipes.enableSolarNeutronActivator = Mekanism.configurationrecipes.get("Recipes","enableSolarNeutronActivator", true).getBoolean();
		recipes.enableOredictionator = Mekanism.configurationrecipes.get("Recipes","enableOredictionator", true).getBoolean();
		recipes.enableResistiveHeater = Mekanism.configurationrecipes.get("Recipes","enableResistiveHeater", true).getBoolean();
		recipes.enableFormulaicAssembler = Mekanism.configurationrecipes.get("Recipes","enableFormulaicAssembler", true).getBoolean();
		recipes.enableFuelwoodHeater = Mekanism.configurationrecipes.get("Recipes","enableFuelwoodHeater", true).getBoolean();
		recipes.enableEnergyCubes = Mekanism.configurationrecipes.get("Recipes","enableEnergyCubes", true).getBoolean();
		recipes.enableObsidianTNT = Mekanism.configurationrecipes.get("Recipes","enableObsidianTNT", true).getBoolean();
		recipes.enableGasTanks = Mekanism.configurationrecipes.get("Recipes","enableGasTanks", true).getBoolean();
		recipes.enablePlasticBlocks = Mekanism.configurationrecipes.get("Recipes","enablePlasticBlocks", true).getBoolean();
		recipes.enableSaltBlock = Mekanism.configurationrecipes.get("Recipes","enableSaltBlock", true).getBoolean();
		recipes.enableUniversalCables = Mekanism.configurationrecipes.get("Recipes","enableUniversalCables", true).getBoolean();
		recipes.enableMechanicalPipes = Mekanism.configurationrecipes.get("Recipes","enableMechanicalPipes", true).getBoolean();
		recipes.enablePressurizedTubes = Mekanism.configurationrecipes.get("Recipes","enablePressurizedTubes", true).getBoolean();
		recipes.enableLogisticalTransporter = Mekanism.configurationrecipes.get("Recipes","enableLogisticalTransporter", true).getBoolean();
		recipes.enableThermoConductors = Mekanism.configurationrecipes.get("Recipes","enableThermoConductors", true).getBoolean();
		recipes.enableElectricBow = Mekanism.configurationrecipes.get("Recipes","enableElectricBow", true).getBoolean();
		recipes.enableEnergyTablet = Mekanism.configurationrecipes.get("Recipes","enableEnergyTablet", true).getBoolean();
		recipes.enableMachineUpgrades = Mekanism.configurationrecipes.get("Recipes","enableMachineUpgrades", true).getBoolean();
		recipes.enableRobit = Mekanism.configurationrecipes.get("Recipes","enableRobit", true).getBoolean();
		recipes.enableAtomicDisassembler = Mekanism.configurationrecipes.get("Recipes","enableAtomicDisassembler", true).getBoolean();
		recipes.enableCircuits = Mekanism.configurationrecipes.get("Recipes","enableCircuits", true).getBoolean();
		recipes.enablePortableTeleporter = Mekanism.configurationrecipes.get("Recipes","enablePortableTeleporter", true).getBoolean();
		...
		recipes.enableConfigurationCard = Mekanism.configurationrecipes.get("Recipes","enableConfigurationCard", true).getBoolean();
		recipes.enableCraftingFormula = Mekanism.configurationrecipes.get("Recipes","enableCraftingFormula", true).getBoolean();
		recipes.enableSeismicReader = Mekanism.configurationrecipes.get("Recipes","enableSeismicReader", true).getBoolean();
		recipes.enableHDPEParts = Mekanism.configurationrecipes.get("Recipes","enableHDPEParts", true).getBoolean();
		recipes.enableFlamethrower = Mekanism.configurationrecipes.get("Recipes","enableFlamethrower", true).getBoolean();
		recipes.enableGaugeDropper = Mekanism.configurationrecipes.get("Recipes","enableGaugeDropper", true).getBoolean();
		recipes.enableTierInstaller = Mekanism.configurationrecipes.get("Recipes","enableTierInstaller", true).getBoolean();
